...
:root {
  ...
  --cui-modal-header-padding:                 12px var(--cui-spacing-4);
  ...
  --cui-modal-max-width:                      360px;
  --cui-modal-offset-x:                       -180px; /* Half of --cui-modal-max-width and negative */
